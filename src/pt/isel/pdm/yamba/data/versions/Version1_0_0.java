...
public class Version1_0_0 extends DefaultVersionProcess {
	...
	private String TableTimeline = "CREATE TABLE Timeline ( ID INTEGER PRIMARY KEY AUTOINCREMENT, MESSAGE TEXT NOT NULL, PUBLICATION_DATE TEXT NOT NULL, REPLY_TO INT NOT NULL, PUBLISHED INTEGER NOT NULL)";
